...
(function (root) {
  ...
  function icon(name, cls) {
    ...
    var arrow = /^arrow-/.test(name) ? " icon--arrow" : "";
    return '<svg class="icon icon--' + name + arrow + (cls ? " " + cls : "") + '" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">' + ICONS[name] + "</svg>";
  }

  root.MJUI = { icon: icon, ICONS: ICONS };
